...
export class ProductService {
  ...
  form: FormGroup = new FormGroup({
    ...
    BusinessAssociate_Legal_Id: new FormControl(null),
  });
  ...
  public getPhotosByCode(productCode: number): Observable<ProductPhoto[]> {
    return this.comunicationService
      .getPhotosByProductCode(productCode)
      .pipe(catchError((error) => throwError(() => error)));
  }
  ...
  public updatePhoto(
    ...
    return this.comunicationService
      .updateProductPhoto(productCode, oldPhotoUrl, update)
      .pipe(catchError((error) => throwError(() => error)));
  }
  ...
  public deletePhoto(productCode: number, photoUrl: string): Observable<void> {
    return this.comunicationService
      .deleteProductPhoto(productCode, photoUrl)
      .pipe(catchError((error) => throwError(() => error)));
  }
