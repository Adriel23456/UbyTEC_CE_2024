...
import { Cart, CartCreate, CartProduct, CartProductCreate, CartProductUpdate, CartUpdate } from '../Cart/cart.service';
import { Order, OrderCreate, OrderProduct, OrderProductCreate, OrderProductUpdate, OrderUpdate } from '../Order/order.service';
...
export class ComunicationService {
  ...
  getProductsByCartCode(cartCode: number): Observable<CartProduct[]> {
    ...
    return this.http.get<CartProduct[]>(
      `${this.apiUrl}/Cart_Product/${cartCode}/Products`,
      { headers: this.headers }
    ).pipe(catchError(this.handleError(operation)));
  }
  ...
  createOrderProduct(orderProduct: OrderProductCreate): Observable<OrderProduct> {
  ...
  getProofOfPayments(): Observable<ProofOfPayment[]> {
    ...
    return this.http.get<ProofOfPayment[]>(
      `${this.apiUrl}/ProofOfPayment`,
      { headers: this.headers }
    ).pipe(catchError(this.handleError(operation)));
  }
  ...
  getProofOfPaymentByCode(code: number): Observable<ProofOfPayment> {
    ...
    return this.http.get<ProofOfPayment>(
      `${this.apiUrl}/ProofOfPayment/${code}`, 
      { headers: this.headers }
    ).pipe(catchError(this.handleError(operation)));
  }

  createProofOfPayment(proofOfPayment: ProofOfPaymentCreate): Observable<ProofOfPayment> {
    const operation = 'POST Create ProofOfPayment';
    return this.http.post<ProofOfPayment>(
      `${this.apiUrl}/ProofOfPayment`,
      proofOfPayment,
      { headers: this.headers }
    ).pipe(catchError(this.handleError(operation)));
  ...
  updateProofOfPayment(code: number, proofOfPayment: ProofOfPaymentUpdate): Observable<void> {
  ...
  getConsolidatedSalesReport(): Observable<ConsolidatedSalesReport[]> {
    ...
    return this.http.get<ConsolidatedSalesReport[]>(
  ...
  getSalesReportByAffiliate(): Observable<SalesReportByAffiliate[]> {
    ...
    return this.http.get<SalesReportByAffiliate[]>(
  ...
  public getAdminsByFilter(filter: string): Observable<Admin[]> {
    ...
    return this.http.get<Admin[]>(`${this.apiUrl}/Extras/GetAdminsByFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getBusinessAssociatesByFilter(filter: string): Observable<BusinessAssociate[]> {
    ...
    const params = new HttpParams().set('filter', filter);
    return this.http.get<BusinessAssociate[]>(`${this.apiUrl}/Extras/GetBusinessAssociatesByFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getBusinessManagersByFilter(filter: string): Observable<BusinessManager[]> {
    ...
    const params = new HttpParams().set('filter', filter);
    return this.http.get<BusinessManager[]>(`${this.apiUrl}/Extras/GetBusinessManagersByFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getAcceptedBusinessAssociatesByFilter(filter: string): Observable<BusinessAssociate[]> {
    ...
    const params = new HttpParams().set('filter', filter);
    return this.http.get<BusinessAssociate[]>(`${this.apiUrl}/Extras/GetAcceptedBusinessAssociatesByFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getClientsByFilter(filter: string): Observable<Client[]> {
    ...
    const params = new HttpParams().set('filter', filter);
    return this.http.get<Client[]>(`${this.apiUrl}/Extras/GetClientsByFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getFoodDeliveryMenByFilter(filter: string): Observable<FoodDeliveryMan[]> {
    ...
    const params = new HttpParams().set('filter', filter);
    return this.http.get<FoodDeliveryMan[]>(`${this.apiUrl}/Extras/GetFoodDeliveryMenByFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getBusinessTypesByFilter(filter: string): Observable<BusinessType[]> {
    ...
    const params = new HttpParams().set('filter', filter);
    return this.http.get<BusinessType[]>(`${this.apiUrl}/Extras/GetBusinessTypesByFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getOrdersByClientNameBusinessAndStateFilter(businessId: number, clientFilter: string, stateFilter: string): Observable<Order[]> {
    ...
    return this.http.get<Order[]>(`${this.apiUrl}/Extras/GetOrdersByClientNameBusinessAndStateFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getProductsByNameAndBusiness(businessId: number, filter: string): Observable<Product[]> {
    ...
    const params = new HttpParams()
      .set('businessId', businessId.toString())
      .set('filter', filter);
    return this.http.get<Product[]>(`${this.apiUrl}/Extras/GetProductsByNameAndBusiness`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getCartsByBusinessName(filter: string): Observable<Cart[]> {
    ...
    const params = new HttpParams().set('filter', filter);
    return this.http.get<Cart[]>(`${this.apiUrl}/Extras/GetCartsByBusinessName`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getProductsByCartAndFilter(cartCode: number, filter: string): Observable<Product[]> {
    ...
    const params = new HttpParams()
      ...
      .set('filter', filter);
    return this.http.get<Product[]>(`${this.apiUrl}/Extras/GetProductsByCartAndFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getLast10OrdersByClient(clientId: number): Observable<Order[]> {
    ...
    return this.http.get<Order[]>(`${this.apiUrl}/Extras/GetLast10OrdersByClient`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
  ...
  public getOrdersByDateFilter(dateFilter: string): Observable<Order[]> {
    ...
    return this.http.get<Order[]>(`${this.apiUrl}/Extras/GetOrdersByDateFilter`, { headers: this.headers, params })
      .pipe(catchError(this.handleError(operation)));
  }
}
