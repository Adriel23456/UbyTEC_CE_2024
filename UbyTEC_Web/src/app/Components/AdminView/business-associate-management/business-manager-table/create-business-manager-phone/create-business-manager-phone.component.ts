...
@Component({
  selector: 'app-create-business-manager-phone',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    CommonModule
  ],
  templateUrl: './create-business-manager-phone.component.html',
  styleUrl: './create-business-manager-phone.component.css'
})
export class CreateBusinessManagerPhoneComponent {
  phoneForm: FormGroup;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateBusinessManagerPhoneComponent>,
    @Inject(MAT_DIALOG_DATA) public data: { Email: string, phones: BusinessManagerPhone[] }
  ) {
  ...
  onConfirm(): void {
    if (this.phoneForm.valid) {
      ...
      if (isDuplicate) {
        ...
        const phone: BusinessManagerPhone = { Phone: newPhone, BusinessManager_Email: this.data.Email };
