...
import { BusinessAssociate, BusinessAssociatePhone, BusinessAssociateService, BusinessAssociateUpdate } from '../../../Services/BusinessAssociate/business-associate.service';
...
@Component({
  ...
  styleUrl: './edit-associate.component.css'
})
