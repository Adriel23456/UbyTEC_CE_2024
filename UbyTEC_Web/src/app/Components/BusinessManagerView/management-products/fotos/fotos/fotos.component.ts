...
import { UpdateCrearFotosComponent } from '../update-crear-fotos/update-crear-fotos.component';
...
export class FotosComponent {
  ...
  crearFoto() {
    ...
    this.dialog
      .open(UpdateCrearFotosComponent, {
        height: '85%',
        maxWidth: '540px',
        width: '540px',
      })
  ...
  eliminarFoto(row: any) {
    this.service.deletePhoto(row.Product_Code, row.PhotoURL).subscribe(() => {
      this.ngOnInit();
    });
  }
}
