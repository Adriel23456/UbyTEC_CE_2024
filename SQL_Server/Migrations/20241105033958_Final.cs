    ...
    public partial class Final : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Legal_Id = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    Canton = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    District = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SINPE = table.Column<long>(type: "bigint", nullable: false),
                    RejectReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BusinessManager_Email = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BusinessType_Identification = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Cart_Code = table.Column<long>(type: "bigint", nullable: false),
                    Product_Code = table.Column<long>(type: "bigint", nullable: false),
